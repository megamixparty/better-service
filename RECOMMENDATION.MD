...
13. Menambahkan unit testing agar setiap perubahan yang terjadi dalam kode bisa diperiksa terlebih dahulu sebelum naik ke production. Untuk poin ini, unit test akan ditambahkan ke file `api/customer/sql.go` function CreateCustomer
